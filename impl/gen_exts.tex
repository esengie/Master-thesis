...
\begin{lstlisting}[caption={Определение представителей классов Eq и Show для представления АСТ}, captionpos=b, frame=single, float,floatplacement=H, label = {lst_inst_eq}]
